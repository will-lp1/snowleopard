...
export const getDisplayPlans = (t: (content: string) => string) => [
  {
                  ...
                  >
                    <div className="flex-grow">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        {plan.annual && <div className="text-xs font-semibold text-primary bg-primary/10 px-2 py-0.5 rounded-full">{t('Save {discount}%', { discount: plan.discount })}</div>}
                      </div>
