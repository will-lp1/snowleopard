...
import { StyleToggleDemo } from "./style-toggle-demo";
...
export function Features() {
  ...
  return (
    <section
      ...
      className={`py-12 sm:py-16 lg:py-20 ${isFeaturesInView ? 'in-view' : ''}`}
    >
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
        <div className="text-center mb-12 sm:mb-16">
          <h2 id="features-heading" className={`text-3xl sm:text-4xl md:text-5xl font-medium ${crimson.className} tracking-tight text-foreground`}>
            Explore the Magic
          </h2>
          <p className="mt-4 text-base sm:text-lg text-muted-foreground max-w-xl mx-auto px-4">
