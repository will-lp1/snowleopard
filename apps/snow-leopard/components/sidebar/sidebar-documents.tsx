...
import { T, useGT, Var, Plural, Branch } from 'gt-next';
    ...
    <>
                ...
                {isSelectionMode && (
                  <>
                    ...
                    >
                      <T>
                        <Branch 
                          branch={selectedDocuments.size === filteredDocuments.length} 
                          true={<>Deselect All</>} 
                          false={<>Select All</>}
                        >
                          Select All
      ...
      <AlertDialog open={showMultiDeleteDialog} onOpenChange={setShowMultiDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <T>
              <AlertDialogTitle>Delete <Var>{selectedDocuments.size}</Var> documents?</AlertDialogTitle>
              <AlertDialogDescription>
          ...
          <AlertDialogFooter>
            ...
            >
              <T>Delete <Var>{selectedDocuments.size}</Var> documents</T>
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
