    ...
    >
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-72">
          <DropdownMenuLabel className="text-xs font-normal text-muted-foreground">{t('Recent Conversations')}</DropdownMenuLabel>
          <DropdownMenuSeparator />
                    ...
                    <div className="mt-1.5 pt-1.5 border-t border-border/50 text-xs flex flex-col gap-1 overflow-hidden">
                      {chat.document_context.active && (
                        <div className="flex items-center gap-1.5 text-muted-foreground truncate">
                          <span className="font-medium text-foreground/80 flex-shrink-0">{t('Active')}:</span>
                          <Link 
                      ...
                      {chat.document_context.mentioned && chat.document_context.mentioned.length > 0 && (
                        <div className="flex items-start gap-1.5 text-muted-foreground">
                          <span className="font-medium text-foreground/80 flex-shrink-0 pt-px">{t('Mentioned')}:</span>
